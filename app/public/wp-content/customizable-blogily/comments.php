...
if ( post_password_required() ) { ?>
	<p class="nocomments"><?php esc_html_e('This post is password protected. Enter the password to view comments','customizable-blogily'); ?>.</p>
<?php return; } ?>

<!-- You can start editing here. -->
<?php if ( have_comments() ) : ?>
	<div id="comments">
		<div class="total-comments"><span><?php comments_number(__('No Comments','customizable-blogily'), __('One Comment','customizable-blogily'),  __('% Comments','customizable-blogily') );?></span></div>
		<ol class="commentlist">
			<div class="navigation">
				<div class="alignleft"><?php previous_comments_link() ?></div>
				<div class="alignright"><?php next_comments_link() ?></div>
			</div>
			<?php wp_list_comments('type=comment&callback=customizable_blogily_comment'); ?>
	...
	<div id="commentsAdd">
		<div id="respond" class="box m-t-6">
			<?php global $aria_req; $comments_args = array(
				'title_reply'=>'<h4><span>'.__('Add a Comment','customizable-blogily').'</span></h4></h4>',
				'label_submit' => __('Add Comment','customizable-blogily'),
