			...
			<span class="post-list">
				<ul class="post-categories">
					<?php if($post_cats_hs =='1'): ?>
						<li><a href="<?php esc_url(get_permalink()); ?>"><i class="fa 	fa-folder-open"></i><?php the_category(', '); ?></a></li>
					<?php endif; ?>	
					<?php if(has_tag() && $post_tags_hs =='1') { ?>
						<li><a href="<?php esc_url(get_permalink()); ?>"><i class="fa fa-tag"></i><?php the_tags(''); ?></a></li>
					<?php } ?>
				</ul>
			</span>
