...
if (!function_exists('foodielicious_blog_color_choice')) :
  ...
  ?>
    ...
    <style type="text/css">
      <?php if (get_theme_mod('foodielicious_blog_show_tags') == '1') : ?>.tags {
        display: none !important;
      }

      <?php endif; ?><?php if (get_theme_mod('foodielicious_blog_show_related_posts') == '1') : ?>.related-posts {
        display: none !important;
      }

      <?php endif; ?><?php if (get_theme_mod('foodielicious_blog_show_about_the_author') == '1') : ?>.postauthor {
        display: block;
      }

      <?php endif; ?>a.readmore-button,
      a.readmore-button:hover {
        background: <?php echo esc_attr(get_theme_mod('primary_theme_color')); ?>;
      }

      <?php if (get_theme_mod('center_header_text') == '0') : ?>.site-branding,
      .site-branding * {
        text-align: center;
      }

      <?php endif; ?>.related-posts .related-posts-no-img h5.title.front-view-title,
      ...
      .sticky-text {
        color: <?php echo esc_attr(get_theme_mod('primary_theme_color')); ?>;
      }
      ...
      .upper-widgets-grid h3:after {
        background-color: <?php echo esc_attr(get_theme_mod('primary_theme_color')); ?>;
      }

      #sidebars .widget h3,
      #sidebars .widget h3 a {
        border-left-color: <?php echo esc_attr(get_theme_mod('primary_theme_color')); ?>;
      }
      ...
      .pagination .current,
      .tagcloud a {
        border-color: <?php echo esc_attr(get_theme_mod('primary_theme_color')); ?>;
      }

      .corner {
        border-color: transparent transparent <?php echo esc_attr(get_theme_mod('primary_theme_color')); ?> transparent;
      }
      ...
      .pagination .dots,
      .post.excerpt {
        background: <?php echo esc_attr(get_theme_mod('all_blog_posts_bg')); ?>;
      }
      ...
      .postauthor {
        background: <?php echo esc_attr(get_theme_mod('post_page_background')); ?>;
      }

      #sidebars .widget {
        background: <?php echo esc_attr(get_theme_mod('sidebar_background_color')); ?>;
      }

      .upper-widgets-grid {
        background: <?php echo esc_attr(get_theme_mod('upper_widgets_background_color')); ?>;
      }

      footer {
        background: <?php echo esc_attr(get_theme_mod('footer_bg_color')); ?>;
      }

      .copyrights {
        background: <?php echo esc_attr(get_theme_mod('footer_copyright_bg_color')); ?>;
      }

      #site-header {
        background-color: <?php echo esc_attr(get_theme_mod('top_header_background_color')); ?>;
      }
      ...
      .pagination2,
      .pagination .dots {
        color: <?php echo esc_attr(get_theme_mod('all_blog_posts_text')); ?>;
      }

      .post.excerpt h2.title a {
        color: <?php echo esc_attr(get_theme_mod('all_blog_posts_headline')); ?>;
      }

      .pagination a,
      .pagination2,
      .pagination .dots {
        border-color: <?php echo esc_attr(get_theme_mod('all_blog_posts_text')); ?>;
      }

      span.entry-meta {
        color: <?php echo esc_attr(get_theme_mod('all_blog_posts_date')); ?>;
      }
      ...
      .total-comments,
      .article th {
        color: <?php echo esc_attr(get_theme_mod('post_page_headline')); ?>;
      }
      ...
      .article #commentform textarea {
        color: <?php echo esc_attr(get_theme_mod('post_page_text')); ?>;
      }

      .article a,
      .breadcrumb a,
      #commentform a {
        color: <?php echo esc_attr(get_theme_mod('post_page_link')); ?>;
      }

      #commentform input#submit,
      #commentform input#submit:hover {
        background: <?php echo esc_attr(get_theme_mod('post_page_link')); ?>;
      }

      .post-date-customizable,
      .comment time {
        color: <?php echo esc_attr(get_theme_mod('post_page_date')); ?>;
      }

      .footer-widgets #searchform input[type='submit'],
      .footer-widgets #searchform input[type='submit']:hover {
        background: <?php echo esc_attr(get_theme_mod('footer_link_color')); ?>;
      }

      .footer-widgets h3:after {
        background: <?php echo esc_attr(get_theme_mod('footer_headline_color')); ?>;
      }

      .footer-widgets h3,
      footer .widget.widget_rss h3 a {
        color: <?php echo esc_attr(get_theme_mod('footer_headline_color')); ?>;
      }
      ...
      .top-column-widget a:focus {
        color: <?php echo esc_attr(get_theme_mod('upper_widgets_link_color')); ?>;
      }

      .top-column-widget,
      .upper-widgets-grid {
        color: <?php echo esc_attr(get_theme_mod('upper_widgets_content_color')); ?>;
      }

      .top-column-widget .widget.widget_rss h3 a,
      .upper-widgets-grid h3,
      .top-column-widget h3 {
        color: <?php echo esc_attr(get_theme_mod('upper_widgets_headlinke_color')); ?>;
      }

      @media screen and (min-width: 865px) {
        .primary-navigation.header-activated #navigation a {
          color: <?php echo esc_attr(get_theme_mod('navigation_frontpage_link_color')); ?>;
        }
      }
      ...
      <?php if (get_theme_mod('toggle_header_frontpage') == '1') : ?>.single #site-header,
      .page #site-header {
        margin-bottom: 0;
      }
...
function display_random_dish_image() {
  ...
  if (empty($images)) {
      echo "No images found in folder: $image_folder";
      return;
  }
  ...
  // Output the image HTML
  echo '<img src="' . esc_url($random_image) . '" alt="Random Dish Image">';
}

// Function to process user input and check the guess
function process_guess() {
  if (isset($_POST['guess'])) {
      $user_guess = sanitize_text_field($_POST['guess']);
      $correct_answer = ''; // Set the correct dish name
      
      // Compare user input with the correct answer
      if (strcasecmp($user_guess, $correct_answer) === 0) {
          echo 'Congratulations! Your guess is correct.';
      } else {
          echo 'Sorry, your guess is incorrect. Try again.';
      }
  }
}

// Shortcode to display the guessing game form
function guessing_game_shortcode() {
  ob_start(); ?>

  <div class="guessing-game">
      <?php display_random_dish_image(); ?>
      <form method="post">
          <label for="guess">Guess the dish:</label>
...
add_shortcode('guessing_game', 'guessing_game_shortcode');
