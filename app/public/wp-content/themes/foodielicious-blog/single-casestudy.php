		...
		<article class="article">		
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
				<div class="single_post">
					...
					<header>
						<!-- Start Title -->
						This is the single-casestudy.php
					...
					if ($categories) { $category_ids = array(); 
						...
						$my_query = new wp_query( $args ); if( $my_query->have_posts() ) {
							echo '<div class="related-posts"><div class="postauthor-top"><h3>'.esc_html__('Related Posts', 'foodielicious-blog').'</h3></div><div class="related-posts-wrapper">';
							...
							while( $my_query->have_posts() ) { 
								...
								<div class="postauthor">
									<h4><?php esc_html_e('About The Author', 'foodielicious-blog'); ?></h4>
